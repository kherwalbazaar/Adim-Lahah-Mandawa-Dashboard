...
export default function Sidebar() {
  ...
  const navItems: NavItem[] = [
    ...
    { icon: Receipt, label: "Payment History", href: "/payment-history" },
    { icon: User, label: "My Profile", href: "/profile" },
    { icon: Settings, label: "Settings", href: "/settings" },
  ]

  return (
    <aside className="w-72 bg-white border-r border-slate-200/80 flex flex-col justify-between p-6 shrink-0">
